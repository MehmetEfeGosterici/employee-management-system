...
class EmployeeController {
    ...
    public ResponseEntity<Void> createEmployee(@RequestBody CreateEmployeeRequest request) {
        CreateEmployeeUseCase.CreateEmployeeCommand command = CreateEmployeeUseCase.CreateEmployeeCommand.builder()
    ...
    public ResponseEntity<Void> updateEmployee(@RequestBody UpdateEmployeeRequest request) {
        UpdateEmployeeUseCase.UpdateEmployeeCommand command = UpdateEmployeeUseCase.UpdateEmployeeCommand.builder()
