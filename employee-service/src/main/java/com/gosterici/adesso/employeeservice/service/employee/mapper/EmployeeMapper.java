...
public interface EmployeeMapper {
    ...
    @Mapping(target = "employeeRoles", expression = "java(mapRoleToEmployeeRole(employee.getRoles()))")
    @Mapping(target = "employeeAddresses", expression = "java(mapAddressToEmployeeAddress(employee.getAddresses()))")
    @Mapping(target = "employeeProjects", expression = "java(mapProjectToEmployeeProject(employee.getProjects()))")
    ...
    default Set<EmployeeResource.EmployeeAddress> mapAddressToEmployeeAddress(Set<Address> addresses) {
    ...
    default List<EmployeeResource.EmployeeProject> mapProjectToEmployeeProject(List<Project> projects) {
