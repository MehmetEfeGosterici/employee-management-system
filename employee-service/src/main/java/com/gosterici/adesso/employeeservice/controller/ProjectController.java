...
public class ProjectController {
  ...
  public ResponseEntity<Void> createProject(
    ...
    CreateProjectUseCase.CreateProjectCommand command =
        CreateProjectUseCase.CreateProjectCommand.builder()
  ...
  public ResponseEntity<Void> updateProjectContributors(
      @PathVariable UUID projectId,
      @RequestBody UpdateProjectContributorsRequest updateProjectContributorsRequest) {
    UpdateProjectUseCase.UpdateProjectContributorsCommand updateProjectContributorsCommand =
        UpdateProjectUseCase.UpdateProjectContributorsCommand.builder()
            .projectId(projectId)
